...
public:
    ...
    bool load_from_ply (std::vector<std::string> filnames,unsigned short _xsiz, unsigned short _ysiz=0, unsigned short _zsiz=0);///create voximg from a ply point cloud
